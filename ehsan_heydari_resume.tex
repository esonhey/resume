...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Documentation}
          {Service for automatically integrating software documents written by technical writers with internal Product applications. Built an internal component library to reuse same components across different applications.}
    ...
    \resumeSubheading
      {Swedish Startup Revruitment}{Stockholm, Sweden}
...
\section{Programming Skills}
 \resumeSubHeadingListStart
   \item{
     ...
     \hfill
     \textbf{Technologies}{: React, D3, Docker, Express, GCE}
   }
 \resumeSubHeadingListEnd
